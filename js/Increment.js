...
function increaseValue(boxID, priceID, subTotalID) {
    //Try to get elements, if not found set value to 0
    try {
        var value = parseInt(document.getElementById(boxID).value, 10);
        var subtotal = parseFloat(document.getElementById(priceID).innerHTML);
    } catch (error) {
        value = 0;
    }
...
function decreaseValue(boxID, priceID, subTotalID) {
    //Try to get elements, if not found set value to 0
    try {
        var value = parseInt(document.getElementById(boxID).value, 10);
        var subtotal = parseFloat(document.getElementById(priceID).innerHTML);
